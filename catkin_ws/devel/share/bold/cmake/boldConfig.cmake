  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bold' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'marc <marc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bold' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marc/ros-vision/catkin_ws/src/bold/${idir}'.  Ask the maintainer 'marc <marc@todo.todo>' to fix it.")
    endif()
